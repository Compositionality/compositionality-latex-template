...
\thanks{You can use the \texttt{\string\email}, \texttt{\string\homepage}, and \texttt{\string\thanks} commands to add additional information for the preceding \texttt{\string\author}. If applicable, this can also be used to indicate that a work has previously been published in conference proceedings.}
